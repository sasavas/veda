...
namespace Veda.Infrastructure.Migrations
{
    ...
    [Migration("20231227202922_EachRecipientHasOneFolder")]
    partial class EachRecipientHasOneFolder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veda.Application.Modules.RecipientModule.Models.Recipient", b =>
                {
                    ...
                    b.HasIndex("FoldersId")
                        .HasDatabaseName("ix_recipient_folders_id");
            ...
            modelBuilder.Entity("Veda.Application.Modules.RecipientModule.Models.Recipient", b =>
                {
                    b.HasOne("Veda.Application.Modules.RecipientModule.Models.Folder", "Folders")
                        .WithMany()
                        .HasForeignKey("FoldersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_recipient_folder_folders_id");
